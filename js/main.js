      ...
      if(event.target.classList.contains("link-item")){
          if(event.target.hash !==""){
              ...
              document.querySelector(".section.active").classList.remove("active");
                ...
                navMenu.querySelector(".active").classList.add("outer-shadow","hove-in-shadow");
                navMenu.querySelector(".active").classList.remove("active","inner-shadow");
                // active new navigation menu 'link-item'
                event.target.classList.add("active","inner-shadow");
                event.target.classList.add("outer-shadow","hover-in-shadow");
                /* if clicked 'link-item' is contained writing the navigation menu */
...
(() =>{
    ...
    tabsContainer .addEventListener("click", (event) =>{
        /*-- if event.target contains tab class and not contains 'active' class----*/
    ...
    function popupToggle(){
        ...
        prevBtn.addEventListener("click", () =>{
            ...
            function popupDetails(){
                // if poftfolio-items-details not exist
               ...
               // set the project title
                ...
                // get the project catergory
                const category = portfolioItems[itemIndex].getAttribute("data-category");
                 // set the project catergory
